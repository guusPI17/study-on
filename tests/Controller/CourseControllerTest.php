...
class CourseControllerTest extends AbstractTest
{
    ...
    // Так как пока что не реализовано редактирование курса на стороне билинга тест не работоспособен(8 занятие нужно)
...
//    }
    ...
    // Так как пока что не реализовано добавление курса на стороне билинга тест не работоспособен(8 занятие нужно)
